...
const timelineData = [
  {
    ...
    organization: 'Mohini Devi Memorial School, Bihar',
    description: 'Completed school education with a focus on science and mathematics. Developed strong analytical and problem-solving skills through various projects and competitions.',
    skills: ['Project Management', 'Prototyping', 'Innovation', 'Problem Solving', 'Hackathons']
  },
  {
    id: 2,
    type: 'education',
    ...
    organization: 'Sri Guru Govind Singh College, PatnaCity',
    ...
    skills: ['Physics', 'Chemistry', 'Mathematics', 'Python', 'Critical Thinking', 'Scientific Analysis']
  },
  {
    id: 3,
    type: 'education',
    ...
    skills: ['C/C++', 'Java', 'HTML/CSS', 'Tailwind CSS', 'PHP', 'Data Structures', 'Algorithms', 'Object-Oriented Programming']
  }
]
