        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <div className="flex space-x-5 mb-4">
              {[
                { icon: <FaGithub size={22} />, href: "https://github.com/Ajayrazz", label: "GitHub" },
                { icon: <FaLinkedin size={22} />, href: "https://www.linkedin.com/in/ajay-razz/", label: "LinkedIn" },
                { icon: <FaTwitter size={22} />, href: "https://x.com/AjayRaz18514034", label: "Twitter" },
                { icon: <FaEnvelope size={22} />, href: "mailto:ajayrazz854334@gmail.com", label: "Email" }
              ].map((social, index) => (
                <motion.a 
                  key={index}
                  href={social.href} 
            ...
            >
              © {currentYear} Ajay Razz. All rights reserved.
            </motion.p>
          </motion.div>
        </div>
