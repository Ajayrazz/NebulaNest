...
const PlatformCard = ({ platform }: { platform: Platform }) => {
  ...
  return (
    ...
    >
      {/* Platform color bar with animation */}
      <motion.div
  ...
  const platforms: Platform[] = [
    {
      ...
      stats: {
        solved: 1105,
        badges: ["625+ Day Streak", "More than 1105 Problems Solved", "30+ Badges Earned"],
        streak: 625,
        contests: 20,
      }
    },
  ...
  return (
    <section id="competitive-programming" ref={sectionRef} className="py-20 scroll-mt-20 relative">
      ...
      <motion.p
        ...
        transition={{ duration: 0.5, delay: 0.2 }}
      >
        Exploring the art of problem-solving through algorithms and data structures, with a passion for competitive programming challenges.
      </motion.p>
