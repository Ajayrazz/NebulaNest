      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-4">
              {/* <span className="text-text">Ajay Razz</span> */}
              <span className="gradient-text animate-gradient">Ajay Razz</span>
            </h1>
          </motion.div>
          ...
          >
            <p className="text-textLight mb-8 text-base lg:text-lg max-w-lg leading-relaxed">
              I design and develop scalable web, Android, and iOS applications with a focus on performance and user experience.
            </p>
          </motion.div>
        ...
        >
          <div className="relative">
            {/* Decorative elements */}
            <motion.div
              className="absolute -inset-4  border-2 border-accent/20"
              animate={{ rotate: 360 }}
              transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
            ></motion.div>

            <motion.div
              className="absolute -inset-10  border border-accent/10"
              animate={{ rotate: -360 }}
              transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
            ></motion.div>

            <div className="relative w-60 h-60 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-md overflow-hidden border-4 border-accent/80 shadow-2xl shadow-accent/20">
